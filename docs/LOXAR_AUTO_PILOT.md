...
- Avance P1 actual: se extrajeron `ToastContainer`, `OfflineBanner`, `AmbientLights` y
  `ProjectBootstrapBanner` de `App.tsx` como pasos de descomposición posteriores a P1-2e
