...
import { callAi, cleanseJson, extractJson } from '../services/geminiService';
...
const AiMapperModal = ({ canvas, conlangName, onApply, onClose, aiAvailable }: { canvas: SyntaxCanvasType, conlangName: string, onApply: (nodes: SyntaxNode[], conns: SyntaxConnection[]) => void, onClose: () => void, aiAvailable?: boolean }) => {
